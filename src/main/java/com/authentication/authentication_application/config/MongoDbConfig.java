...
/**
 * MongoDB configuration for setting up indexes. Ensures optimal query
 * performance and data integrity by creating indexes on frequently queried
 * fields.
 */
@Configuration
...
public class MongoDbConfig {
	...
	/**
	 * Initializes MongoDB indexes for the User collection. Called automatically
	 * after the bean is created. Creates indexes on: - email: Unique index for fast
	 * user lookups and duplicate prevention - profileId: Unique index for
	 * profile-based queries - createdAt: Index for sorting recent accounts
	 */
	@PostConstruct
