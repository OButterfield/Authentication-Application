...
/**
 * Utility class for hashing strings using bcrypt with salt and pepper. Provides
 * methods to hash and verify hashed values. Pepper is a server-side secret
 * added to all inputs before hashing.
 */
public class HashUtil {
	 ...
	 *
	 * @param pepper
	 *            the server-side secret to append to all inputs
	 * @throws IllegalArgumentException
	 *             if pepper is null or empty
	 */
	...
	/**
	 * Hashes a plain text string using bcrypt with salt and pepper. The pepper is
	 * appended to the input before hashing.
	 *
	 * @param plainText
	 *            the string to hash
	...
	/**
	 * Verifies that a plain text string matches a hashed value. The pepper is
	 * appended to the plainText before comparison.
	 *
	 * @param plainText
	 *            the plain text string to verify
	 * @param hash
	 *            the hashed string to compare against
	 * @return true if the plainText matches the hash, false otherwise
	 * @throws IllegalArgumentException
	 *             if plainText or hash is null
	 */
