...
/**
 * Service for creating and managing user sessions.
 * Responsible only for session creation and persistence.
 * Follows Single Responsibility Principle by focusing solely on session logic.
 */
@Service
...
public class SessionService {
    ...
    /**
     * Creates a new session for the authenticated user and persists it to the database.
     * Generates a unique sessionId and calculates expiry time (1 hour from now).
     *
