...
/**
 * Unit tests for UserAuthenticationService. Tests user authentication via email
...
class UserAuthenticationServiceTest {
	...
	void shouldAuthenticateUserWithValidCredentials() {
		// GIVEN
		User storedUser = User.builder().id(MONGO_ID).profileId(TEST_PROFILE_ID).email(TEST_EMAIL)
				.hashedPassword(HASHED_PASSWORD).createdAt(TEST_TIMESTAMP).updatedAt(TEST_TIMESTAMP)
