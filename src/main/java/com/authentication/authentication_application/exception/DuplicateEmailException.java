...
public class DuplicateEmailException extends AuthenticationApplicationException {
    ...
    /**
     * Constructs a DuplicateEmailException with a generic error message.
     * The message does not reveal whether the email already exists to prevent security issues.
     */
