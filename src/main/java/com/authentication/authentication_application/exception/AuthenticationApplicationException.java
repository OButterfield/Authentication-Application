...
/**
 * Base exception class for all authentication application exceptions. Provides
 * common error handling properties and behavior. All custom exceptions in the
...
public class AuthenticationApplicationException extends RuntimeException {
	...
	/**
	 * -- GETTER -- Gets the error code for this exception.
	 *
	 ...
	 *
	 * @param errorCode
	 *            the error code identifier (e.g., "DUPLICATE_EMAIL",
	 *            "INVALID_INPUT")
	 * @param message
	...
	/**
	 * Constructs an AuthenticationApplicationException with error code, message,
	 * and cause.
	 *
	 * @param errorCode
