...
/**
 * Repository interface for User document persistence in MongoDB.
 * Provides CRUD operations and custom query methods.
 * Extends MongoRepository for automatic implementation by Spring Data MongoDB.
 */
@Repository
public interface UserRepository extends MongoRepository<User, String> {
     ...
     * Email is indexed in MongoDB for fast lookups.
     *
    ...
    /**
     * Finds a user by their profile ID.
     * Profile ID is unique and indexed in MongoDB.
     *
     * @param profileId the user's unique profile identifier
     * @return Optional containing the user if found, empty otherwise
     */
     ...
     * Useful for preventing duplicate account creation.
     *
     * @param email the user's email address
